...
#include <ArrayManager.h>
 ...
 void p_cache::getca_line_structFromType(Type *t, ca_line_struct *ca_line_structInstance) {
...
// p_cache Constructor
// --------------------------------------------------------
p_cache::p_cache(char*n , char status0_i, char status1_i, int cache_size_i) :
  sim_entity(n),
  from_mips(n),
  to_mips(n),
  to_s_cache(n),
...
char* p_cache::state_names[] = {"P_HIT ","P_MISS ","P_IDLE "};
// --------------------------------------------------------

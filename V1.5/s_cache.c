...
#include <ArrayManager.h>
 ...
 void s_cache::getca_line_structFromType(Type *t, ca_line_struct *ca_line_structInstance) {
  ca_line_structInstance->ca_valid = ((Int *)((Struct *)t)->getField(0))->intValue();
  ca_line_structInstance->ca_mod = ((Int *)((Struct *)t)->getField(1))->intValue();
  ca_line_structInstance->ca_share = ((Int *)((Struct *)t)->getField(2))->intValue();
  ca_line_structInstance->ca_tag = ((Int *)((Struct *)t)->getField(3))->intValue();
  ca_line_structInstance->ca_cm_block = ((Int *)((Struct *)t)->getField(4))->intValue();
  ca_line_structInstance->ca_add1 = ((Int *)((Struct *)t)->getField(5))->intValue();
  ca_line_structInstance->ca_add2 = ((Int *)((Struct *)t)->getField(6))->intValue();
  ca_line_structInstance->ca_add3 = ((Int *)((Struct *)t)->getField(7))->intValue();
  ca_line_structInstance->ca_add4 = ((Int *)((Struct *)t)->getField(8))->intValue();
}
// --------------------------------------------------------
// s_cache Constructor
// --------------------------------------------------------
s_cache::s_cache(char*n , char status0_i, char status1_i, int cache_size_i) :
  sim_entity(n),
  from_p_cache(n),
  to_p_cache(n),
  to_mp_bus(n),
  ...
  cache(cache_size_i,"cache")
{
  ...
  if (__cacheTotal == -1) printf("No memory file found for %s.cache.\n", get_name());
  else if (__cacheTotal < 0) printf("%s:Error reading memory cache, line %d.\n", get_name(), -(__cacheTotal + 2));
  else {
...
char* s_cache::state_names[] = {"S_HIT ","S_MISS ","S_IDLE "};
// --------------------------------------------------------
